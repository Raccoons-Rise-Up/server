...
Not all the things to do are listed in the [issues](https://github.com/Raccoons-Rise-Up/server/issues), if you want to know more of what needs to be done please talk to `valk#9904` in the [Kittens Rise Up](https://discord.gg/cDNf8ja) discord for more info.
